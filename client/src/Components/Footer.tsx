...
export default function Footer() {
  return (
    <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 pl-4 overflow-x-hidden">
        ...
        <div className="-mx-4 flex flex-wrap md:justify-between">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-7 text-base text-body-color">
                Somos una comercializadora de bebidas de agave especializados en
                el mezcal mexicano, aquí podrás encontrar bebidas para todo los
                paladares.
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-base text-body-color">&copy; 2022 Agave</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <span className="absolute top-10 right-20 z-[-1]">
          <svg
            width="75"
            height="75"
            viewBox="0 0 75 75"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stop-color="#136dc2" stop-opacity="0.31" />
                <stop offset="1" stop-color="#C4C4C4" stop-opacity="0" />
              </linearGradient>
            </defs>
          </svg>
